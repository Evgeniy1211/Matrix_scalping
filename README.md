...
**Единый источник правды**: `backend/data/`

- `technologies.ts` - 17 технологий с детальными описаниями
- `evolution-data.ts` - матрица эволюции и дерево технологий
- `trading-machines.ts` - кейсы торговых систем
- `modules/` - описания модулей торговых систем

**API endpoints**:

- `GET /api/technologies` - база технологий
- `GET /api/evolution-data` - матрица эволюции
- `GET /api/trading-machines` - кейсы торговых машин
- `GET /api/modules` - модули систем
...
4. **База технологий** - централизованная информация о 17 технологиях
